...
```
cd existing_repo
git remote add origin https://repo.bfccomputing.com/bfc/apt-deepclean.git
git branch -M main
...
- [ ] [Set up project integrations](https://repo.bfccomputing.com/bfc/apt-deepclean/-/settings/integrations)
